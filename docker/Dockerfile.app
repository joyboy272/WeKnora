...
RUN --mount=type=cache,id=s/e83fb873-e8d2-458c-b0c3-9bc3b214cc18-/go/pkg/mod,target=/go/pkg/mod go mod download
COPY cmd/download cmd/download
RUN go run cmd/download/duckdb/duckdb.go
COPY . .
RUN --mount=type=cache,id=s/e83fb873-e8d2-458c-b0c3-9bc3b214cc18-/go/pkg/mod,target=/go/pkg/mod bash ./scripts/copy-licenses.sh /license-bundle
...
ENV RUSTUP_HOME=/usr/local/rustup CARGO_HOME=/usr/local/cargo
ENV PATH=/usr/local/cargo/bin:$PATH
RUN --mount=type=cache,id=s/e83fb873-e8d2-458c-b0c3-9bc3b214cc18-/usr/local/cargo/registry,target=/usr/local/cargo/registry \
    --mount=type=cache,id=s/e83fb873-e8d2-458c-b0c3-9bc3b214cc18-/usr/local/cargo/git,target=/usr/local/cargo/git \
...
RUN --mount=type=cache,id=s/e83fb873-e8d2-458c-b0c3-9bc3b214cc18-/go/pkg/mod,target=/go/pkg/mod \
    if [ "$WITH_ANYDOC" = "1" ]; then \
        make build-prod GO_BUILD_TAGS=anydoc; \
    else \
        make build-prod; \
    fi
RUN --mount=type=cache,id=s/e83fb873-e8d2-458c-b0c3-9bc3b214cc18-/go/pkg/mod,target=/go/pkg/mod cp -r /go/pkg/mod/github.com/yanyiwu/ /app/yanyiwu/
